...
execute_insert_query() {
    ...
    local result
    result=$(psql -h ${HOST} -p ${PORT} -U ${USERNAME} -d ${DATABASE} -c "\timing" -c "explain analyze $query")
